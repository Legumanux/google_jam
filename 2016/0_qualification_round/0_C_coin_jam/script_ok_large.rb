...
def getDivisorsList(maxVal)
  res = Array.new(maxVal+1)
  res.push(2)
  for val in 0..maxVal
    res[val] = getTrivialDivisor(val)
  end
  return res
end
...
def process(n, j)
  ...
  divisorsList = getDivisorsList(10**n)
  puts "tous les diviseurs trouves"
  ...
  for midValB2 in 0..(2**(n-2)-1)
    ...
    for base in 2 .. 10
      ...
      trivialDivisor = divisorsList[valBase]#getTrivialDivisor(valBase)
      if (trivialDivisor > 1)
